                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        ...
                        @elseif(Auth::user()->isRentalOfficer())
                            ...
                            <x-nav-link :href="route('officer.announcements.index')" :active="request()->routeIs('officer.announcements.*')">
                                {{ __('Announcements') }}
                            </x-nav-link>
                        ...
                        @else
                            ...
                            <x-nav-link :href="route('feedback.my')" :active="request()->routeIs('feedback.my')">
                                {{ __('My Feedbacks') }}
                            </x-nav-link>
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                ...
                @elseif(Auth::user()->isRentalOfficer())
                    ...
                    <x-responsive-nav-link :href="route('bookings.all')" :active="request()->routeIs('bookings.all')">
                        {{ __('Bookings') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('feedback.all')" :active="request()->routeIs('feedback.all')">
                        {{ __('Feedbacks') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('officer.announcements.index')" :active="request()->routeIs('officer.announcements.*')">
                        {{ __('Announcements') }}
                    </x-responsive-nav-link>
                ...
                @else
                    ...
                    <x-responsive-nav-link :href="route('feedback.my')" :active="request()->routeIs('feedback.my')">
                        {{ __('My Feedbacks') }}
                    </x-responsive-nav-link>
