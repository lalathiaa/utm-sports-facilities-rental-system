<x-app-layout>
    ...
    <div style="max-width:1100px;margin:0 auto;">
        ...
        <div style="display:grid;grid-template-columns:1fr 340px;gap:20px;align-items:start;">
            ...
            {{-- ══ RIGHT: Upcoming Closures Sidebar ══ --}}
            <div class="utm-card animate-in animate-in-delay-1" style="position:sticky;top:80px;">
                <div class="utm-card-header">
                                ...
                                <div style="display:flex;flex-wrap:wrap;gap:5px;">
                                    @if($group->whereNull('slot_start')->isNotEmpty())
                                        ...
                                        @if($group->first()->reason)
                                            <span style="font-size:11px;color:var(--slate-400);padding:3px 0;">
                                                — {{ $group->first()->reason }}
                                            </span>
                                        @endif
                                    @else
